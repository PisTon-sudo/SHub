// src/pages/ProviderCardDetails.jsx
...
const ProviderCardDetails = () => {
  ...
  const provider = useMemo(
    () => providers.find(p => p.id === parseInt(id)),
    [id]
  );
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950">
        <div className="text-center">
          <h2 className="text-3xl font-black">Provider Not Found</h2>
          <button
            onClick={() => navigate('/')}
      ...
      <main className="pt-28 pb-20 max-w-7xl mx-auto px-6">
        ...
        <div className="flex justify-between items-center mb-12">
          <nav className="flex items-center space-x-2 text-xs font-black uppercase tracking-widest text-slate-400">
            ...
            <Link to="/providers" className="hover:text-blue-600">Providers</Link>
            <ChevronRightIcon className="h-3 w-3 opacity-50" />
            <span className="text-blue-600 truncate max-w-[220px]">{provider.name}</span>
          </nav>
          ...
          <div className="lg:col-span-8 space-y-14">
            ...
            <header>
              <div className="flex items-center gap-2 text-blue-600 font-black text-xs uppercase tracking-widest mb-3">
                ...
                {provider.title || 'Verified Provider'}
              </div>
              ...
              <div className="flex flex-wrap gap-8">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-black text-xl">{provider.rating}</span>
                </div>
            ...
            <div className="bg-slate-50 dark:bg-slate-900/50 p-10 rounded-[2.5rem] border border-slate-100 dark:border-slate-800">
              <h3 className="text-2xl font-black mb-6">About the Provider</h3>
              <p className="text-lg leading-relaxed text-slate-600 dark:text-slate-400">
                {provider.description || "This provider is verified and ready to serve your needs."}
              </p>
            </div>
...
export default ProviderCardDetails;
